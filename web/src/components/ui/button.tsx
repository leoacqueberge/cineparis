...
function radiusForSize(size: VariantProps<typeof buttonVariants>["size"]) {
  if (size === "xs" || size === "icon-xs") return 10
  if (size === "sm" || size === "icon-sm") return 12
  return 8
}
...
function Button({
  ...
  useSmoothCorners(ref, corners(radiusForSize(size)))
